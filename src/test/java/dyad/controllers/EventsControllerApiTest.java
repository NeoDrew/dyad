...
@WebMvcTest(StocksControllerApi.class)
@Import({ Security.class, StockModelAssembler.class })
public class EventsControllerApiTest {
	...
	public void getIndexWithEvents() throws Exception {
		...
		when(eventService.findAll()).thenReturn(Collections.<Stock>singletonList(e));
